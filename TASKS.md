...
| T-004 | DBスキーマ実装 | DATA_MODEL.md 準拠のSQLiteスキーマ+マイグレーション基盤(全20テーブル。D-9/D-10/D-11反映、正確座標カラムなし=D-12、追記専用はトリガーで担保=D-23)。先行成果品の分析に基づく補強(Track⇄クリップ多対多、positive/insurance区分、実時刻確実性、特徴量ハイブリッド=D-24/D-25)。DBテスト21件 | Claude Code | 実装完了・T-005レビュー待ち(Issue #4) |
