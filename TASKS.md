...
| T-004 | DBスキーマ実装 | DATA_MODEL.md 準拠のSQLiteスキーマ+マイグレーション基盤(全19テーブル。D-9/D-10/D-11反映、正確座標カラムなし=D-12、追記専用はトリガーで担保=D-23)。DBテスト19件 | Claude Code | 実装完了・T-005レビュー待ち(Issue #4) |
