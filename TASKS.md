...
| T-002 | 設計レビュー | 実装観点での整合性確認。指摘10件はD-7〜D-21として反映済み。Codexの再確認待ち | Codex | 対応中(指摘反映済み・再レビュー待ち) |
...
| ID | タスク | 内容 | 担当 | 状態 |
|---|---|---|---|---|
| T-101 | メディア登録 | 動画取込、SHA-256、FFprobeメタデータ、撮影開始日時確定フロー(MVP要件1-3) | Claude Code | 未着手 |
